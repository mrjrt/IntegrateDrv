...
namespace Microsoft.Deployment.Compression.Cab
{
	...
	{
		private CabPacker _packer;
		private CabUnpacker _unpacker;
		...
		{
			get { return _packer ?? (_packer = new CabPacker(this)); }
		}

		private CabUnpacker Unpacker
		{
			get { return _unpacker ?? (_unpacker = new CabUnpacker(this)); }
		}
