...
namespace Microsoft.Deployment.Compression
{
	...
	public class OffsetStream : Stream
	{
		...
		public OffsetStream(Stream source, long offset)
		{
			...
			_source.Seek(_sourceOffset, SeekOrigin.Current);
		}
		...
		{
			get { return _source.Length - _sourceOffset; }
		}
		...
		{
			get { return _source.Position - _sourceOffset; }
		...
		{
			return _source.Seek(offset + (origin == SeekOrigin.Begin ? _sourceOffset : 0), origin) - _sourceOffset;
		}
		...
		{
			_source.SetLength(value + _sourceOffset);
		}
